...
WebPage::WebPage(QWebEngineProfile *profile, QWebEngineView *parent)
	...
	, parent(parent)
{
	...
	connect(this,
		...
		this,
		&WebPage::fullScreenRequested);
}

void WebPage::fullScreenRequested(QWebEngineFullScreenRequest request)
{
	if (request.toggleOn()) {
		if (m_fullScreenWindow)
			return;
		request.accept();
		m_fullScreenWindow.reset(new FullScreenWindow(parent));
	}
	else {
		if (!m_fullScreenWindow)
			return;
