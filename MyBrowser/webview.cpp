...
QIcon WebView::favIcon() const
{
    ...
    if (m_loadProgress < 0) {
        static QIcon errorIcon(QStringLiteral(":/images/browser/icon/dialog-error.png"));
        return errorIcon;
    } else if (m_loadProgress < 100) {
        static QIcon loadingIcon(QStringLiteral(":/images/browser/icon/view-refresh.png"));
        return loadingIcon;
    } else {
        static QIcon defaultIcon(QStringLiteral(":/images/browser/icon/text-html.png"));
        return defaultIcon;
    }
}
